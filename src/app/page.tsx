  ...
  return (
    <div className="sm:overflow-x-hidden">
      ...
      <div className="flex justify-center mt-4 space-x-4">
        <a href="https://www.linkedin.com/in/muhammad-muchson-7024911b8/" target="_blank" rel="noopener noreferrer" className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full transition duration-300 ease-in-out">LinkedIn</a>
        <a href="https://www.youtube.com/channel/UCXh8wC8rrctCESTKed2aDMQ" target="_blank" rel="noopener noreferrer" className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-full transition duration-300 ease-in-out">YouTube</a>
      </div>
    </div>
